...
cvar_t sv_playerphysicsqc = {CF_SERVER | CF_NOTIFY, "sv_playerphysicsqc", "1", "1 enables QuakeC SV_PlayerPhysics() function to override engine SV_PlayerPhysics(); 2 disables engine SV_LinkEdict_TouchAreaGrid() for when QC wants to handle all client movetypes and trigger touching; 3 does both"};
